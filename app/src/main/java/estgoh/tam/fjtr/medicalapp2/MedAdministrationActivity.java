...
public class MedAdministrationActivity extends AppCompatActivity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administration_med);
        ...
        buttonVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MedAdministrationActivity.this, MainActivity.class);
        ...
        buttonConfirmar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent editarIntent = new Intent(MedAdministrationActivity.this, EditMedActivity.class);
